...
```
[root@db-server ~]# hostnamectl set-hostname web-server
...
```
[root@db-server ~]# hostnamectl set-hostname sb-server
[root@db-server ~]# adduser moonwalker
[root@db-server ~]# passwd moonwalker
[root@db-server ~]# usermod -aG wheel moonwalker
```
...
You can simply follow the steps from the source to download and configure the repository, or just follow the installation suggested by the repository manager after the update, in my case, I just followed the following commands:
...
```
Installed:
  mysql-community-server-8.0.32-1.el7.x86_64     net-tools-2.0-0.25.20131004git.el7.x86_64             
  mysql-community-client-8.0.32-1.el7.x86_64     mysql-community-client-plugins-8.0.32-1.el7.x86_64    
  mysql-community-common-8.0.32-1.el7.x86_64     mysql-community-icu-data-files-8.0.32-1.el7.x86_64    
  mysql-community-libs-8.0.32-1.el7.x86_64       mysql-community-libs-compat-8.0.32-1.el7.x86_64       
